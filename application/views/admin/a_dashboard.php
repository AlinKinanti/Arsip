...
<head>
  ...
  //Fungsi cek dipanggil ketika tombol submit di tekan
  function cek(){
            ...
            <div class="col-md-3">
              ...
              <table style="font-size:15px;">
                ...
                <tr height=25>
                  <td>Jabatan</td>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td align=left>: <b><?php if($this->session->userdata('jabatan') == 1){echo "Staff Arsip BAKORWIL";}else{ echo "Pegawai BAKORWIL 3 Malang";} ?></b></td>
                </tr>
                <tr height=25>
                  <td>NIP</td>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
