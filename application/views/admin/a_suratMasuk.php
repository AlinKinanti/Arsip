        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            <div class="box-header">
              ...
              <form action="<?php echo base_url('ControllerSurat/print_suratmasuk')?>" method ="post">
                <input type="month" name="datePrint" >
                      ...
                      <tr>
                        ...
                        <td><?php echo $item['keterangan']; ?></td>
                          <td align=center>
                            ...
                            <button class="btn btn-warning" onclick="ubah_surat(<?php echo $item['id']; ?>)" title="Edit Surat" ><i class="fa fa-edit"></i></button>
                            <button class="btn btn-danger" onclick="konfirmasi_hapus(<?php echo $item['id']; ?>)" title="Hapus Surat" ><i class="fa fa-trash"></i></button>
                          </td>
                        </tr>
                    <?php
                    $i++;
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form class="form-horizontal" form action="<?php echo base_url('controllerSurat/tambahSuratMasuk')?>" method="post" enctype="multipart/form-data" role="form">
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Sifat</label>
                <div class="col-lg-9">
                  <textarea name="sifatTS" class="form-control" rows="2" cols="80" required></textarea>
                </div>
            </div>
            <div class="form-group">
