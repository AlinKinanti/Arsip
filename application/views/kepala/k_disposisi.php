                    ...
                    if(is_array($itemDisposisi)){
                      ...
                      foreach ($itemDisposisi as $data) {
                        ...
                        <tr>
                          ...
                          <td><?php echo date("d/m/Y", strtotime($data->tglSurat)); ?></td>
                          <td><?php echo $data->pengirim; ?></th>
                          <td><?php echo $data->tujuan; ?></td>
                          <td><?php echo $data->sifat; ?></th>
                          <td><?php if($data->selesai == '0'){echo $data->posisi_surat;}else{echo "Selesai";}  ?></td>
                          <td align=center>
                            <a  <?php if($data->selesai == '0'){echo "data-toggle='modal' data-target='#tambah-data$i' ";}?>  title="Lihat" class="btn bg-olive" ><i class="fa  fa-file">&nbsp;Disposisi</i></a>
                          </td>
                          <td>
                            <a href="<?php echo base_url().'lihatSurat/'.$data->id; ?>" title="Lihat" class="btn bg-olive" target="_blank"><i class="fa  fa-folder-open-o">&nbsp;Lihat Surat</i></a>                        
                          </td>
                          <td align=center>
                            <a  <?php if($data->selesai == '1'){echo "data-toggle='modal' data-target='#lihat-data$i' ";}?>  title="Lihat" class="btn btn-success" ><i class="fa  fa-folder-open-o">&nbsp; Display Disposisi</i></a> 
                          </td>
                          <td align=center>
                          <button class="btn btn-danger" onclick="cetakDisposisi(<?php echo $data->id;?>)" title="Cetak Disposisi" ><i class="fa fa-print"></i></button>
                          </td>
                        </tr>                        
                        <?php
                    $i++;
  ...
  <?php
                    if(is_array($itemDisposisi)){
                      ...
                      foreach ($itemDisposisi as $data) {
                        ...
                        ?>
<!-- /.modal Tambah -->
<div class="modal fade" id="tambah-data<?php echo $i?>">
    <div class="modal-dialog">
      <div class="modal-content box-sizing">
          ...
          <form class="form-horizontal" action="<?php echo base_url('ControllerSurat/updateDisposisi');?> " method="post">
            ...
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Tanggal Disposisi KTU</label>
                <div class="col-lg-9">
                  <input class="form-control" type="date" name="tanggal_ktu" value="<?php  echo $data->tanggal_ktu;?>" <?php if($this->session->userdata('jabatan')!=2){echo 'readonly';}else{echo 'required';}?>>
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Catatan SEKBAN</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" name="catatan_sekban" value="<?php echo  $data->catatan_sekban;?>" <?php if($this->session->userdata('jabatan')!=3){echo 'readonly';}else{echo 'required';}?> >
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Tanggal Disposisi SEKBAN</label>
                <div class="col-lg-9">
                  <input class="form-control" type="date" name="tanggal_sekban" value="<?php  echo $data->tanggal_sekban;?>" <?php if($this->session->userdata('jabatan')!=3){echo 'readonly';}else{echo 'required';}?>>
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Catatan KABAN</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" name="catatan_kaban" value="<?php  echo $data->catatan_kaban;?>" <?php if($this->session->userdata('jabatan')!=4){echo 'readonly';}else{echo 'required';}?>>
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Tanggal Disposisi KABAN</label>
                <div class="col-lg-9">
                  <input class="form-control" type="date" name="tanggal_kaban" value ="<?php  echo $data->tanggal_kaban;?>" <?php if($this->session->userdata('jabatan')!=4){echo 'readonly';}else{echo 'required';}?>>
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Ditujukan Ke</label>
                <div class="col-lg-9" style="margin-top:8px;">
                  <input type="checkbox" name="check_list1[]" <?php if(preg_match('/\bsekban\b/' ,$data->tujuan)){echo 'checked'; }?> value="sekban"> SEKBAN &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" <?php if(preg_match('/\btu2\b/' ,$data->tujuan)){echo 'checked'; }?> value="tu2"> TU 2 &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" <?php if(preg_match('/\bsungram\b/' ,$data->tujuan)){echo 'checked';}?> value="sungram"> Penyusunan Program &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" <?php if(preg_match('/\bkeungan\b/' ,$data->tujuan)){echo 'checked';}?> value="keungan"> Keuangan &nbsp;&nbsp;&nbsp; <br>
                  <input type="checkbox" name="check_list1[]" <?php if(preg_match('/\bpe\b/' ,$data->tujuan)){echo 'checked';}?> value="pe"> Pembangunan Ekonomi &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" <?php if(preg_match('/\bkemas\b/' ,$data->tujuan)){echo 'checked';}?> value="kemas"> Kemasyarakatan &nbsp;&nbsp;&nbsp;
                  <input type="checkbox" name="check_list1[]" <?php if(preg_match('/\bsarpras\b/' ,$data->tujuan)){echo 'checked';}?> value="sarpras"> Sarana Prasarana
                  <input type="checkbox" name="check_list1[]" <?php if(preg_match('/\bpemer\b/' ,$data->tujuan)){echo 'checked';}?> value="pemer"> Pemerintahan &nbsp;&nbsp;&nbsp;
                </div>
            </div>
            <div class="form-group">
                 <div class="col-lg-9" style="margin-top:8px;">                 
                  <input type="checkbox" name="Selesai"  value="Selesai"> Selesai &nbsp;&nbsp;&nbsp;
                </div>
            </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span></button>
          <h4 class="modal-titlee">Hasil Disposisi</h4>
        </div>
        <div class="modal-body">
        <!-- <div class="col-md-3"> -->
          <h2>Data Surat</h2>
          <form class="form-horizontal" action="<?php echo base_url('ControllerSurat/updateDisposisi');?> " method="post">
            <table style="font-size:15px;">
              ...
              <label class="col-lg-3 col-sm-3 control-label">Catatan KTU</label>
                <div class="col-lg-9">
                  <input class="form-control" type="text" name="catatan_ktu" value="<?php echo $data->catatan_ktu;?>" readonly>
                </div>
            </div>
            <div class="form-group">
              <label class="col-lg-3 col-sm-3 control-label">Tanggal Disposisi KTU</label>
