            ...
            <div class="col-md-3">
              ...
              <table style="font-size:15px;">
                ...
                <tr height=25>
                  <td>Jabatan</td>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td align=left>: <b><?php if($this->session->userdata('jabatan') == 2){echo " KASUBAG TU BAKORWIL";} else if($this->session->userdata('jabatan') == 3){echo "SEKERTARIS BAKORWIL";} else if($this->session->userdata('jabatan') == 4){echo "KEPALA BAKORWIL";} else{ echo "KEPALA BAKORWIL";} ?></b></td>
                </tr>
                <tr height=25>
                  <td>NIP</td>
                  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
